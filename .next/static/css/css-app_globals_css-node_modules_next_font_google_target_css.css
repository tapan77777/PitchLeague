...
.border-\[var\(--league-primary\2c \#16a34a\)\] {
  border-color: var(--league-primary,#16a34a);
}
.border-amber-900 {
  --tw-border-opacity: 1;
...
.bg-\[var\(--league-primary\2c \#16a34a\)\] {
  background-color: var(--league-primary,#16a34a);
}
.bg-\[var\(--league-primary-10\2c \#16a34a1a\)\] {
  background-color: var(--league-primary-10,#16a34a1a);
}
.bg-amber-950 {
  --tw-bg-opacity: 1;
...
.text-\[var\(--league-primary\2c \#16a34a\)\] {
  color: var(--league-primary,#16a34a);
}
.text-amber-400 {
  --tw-text-opacity: 1;
...
/* ============================================
   PITCHLEAGUE — Global Styles
   League theme is injected via CSS variables
   on the root element per-league
   ============================================ */

:root {
  --league-primary: #16a34a;
  --league-accent: #15803d;
  --league-primary-10: #16a34a1a;
  --league-primary-20: #16a34a33;
}
...
/* Match card score input - remove default number arrows */
...
/* League branded gradient */
.league-gradient {
  background: linear-gradient(
    135deg,
    var(--league-primary) 0%,
    var(--league-accent) 100%
  );
}
